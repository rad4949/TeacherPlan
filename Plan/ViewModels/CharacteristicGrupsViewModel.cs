...
{
    public class CharacteristicGrupsViewModel
    {      
    ...
    public class ListCharacteristicGrups1ViewModel
    {
        public List<CharacteristicGroupsSemestr1> listCharacteristicGpoups { get; set; }
        public AllUserViewModel userModel { get; set; }
    }

    public class ListCharacteristicGrups2ViewModel
    {
        public List<CharacteristicGroupsSemestr2> listCharacteristicGpoups { get; set; }
        public AllUserViewModel userModel { get; set; }
    }
