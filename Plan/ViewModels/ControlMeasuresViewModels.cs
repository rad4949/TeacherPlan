...
{
    public class ControlMeasuresViewModels
    {
    ...
    public class ListControlMeasuresViewModelsSemestr1
    {
        public List<ControlMeasuresSemestr1> listControlMeasures { get; set; }
        public AllUserViewModel userModel { get; set; }
    }

    public class ListControlMeasuresViewModelsSemestr2
    {
        public List<ControlMeasuresSemestr2> listControlMeasures { get; set; }
        public AllUserViewModel userModel { get; set; }
    }

    public class ListSumControlMeasuresViewModels
    {
        public List<ControlMeasuresSemestr1> listSumControlMeasures { get; set; }

        public List<LectureClassesTableNameSum> listNameControlMeasures { get; set; }
        public AllUserViewModel userModel { get; set; }
    }
}
