...
{
    public class LectureClassesViewModel
    {
    ...
    public class ListLectureClasses1ViewModel
    {
        public List<LectureClassesTableSemestr1> listLectureClasses { get; set; }
        public AllUserViewModel userModel { get; set; }
    }

    public class ListLectureClasses2ViewModel
    {
        public List<LectureClassesTableSemestr2> listLectureClasses { get; set; }
        public AllUserViewModel userModel { get; set; }
    }

    public class ListLectureClassesSumViewModel
    {
        public List<LectureClassesTableSemestr1> listLectureClasses { get; set; }

        public List<LectureClassesTableNameSum> listNameLectureClasses { get; set; }
        public AllUserViewModel userModel { get; set; }
    }
}
